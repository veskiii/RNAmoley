    ...
    <div className="w-full h-full" style={{ color: "black" }}>
      ...
      <div className="flex flex-col items-center px-[10vw] pt-6">
        <form onSubmit={handleSubmit}>
          <div
            className="grid p-4 items-start content-center justify-items-center h-[80vh] w-[80vw] bg-teal-100 p-24 rounded-xl text-teal-600 font-semibold text-lg shadow-md"
          ...
          >
            <div className="w-full  p-4 rounded-md text-center mb-6">
              ...
              <p>
                The webserver analyzes RNA 3D structures to assess their quality
                by examining structural elements. You can upload PDB/mmCIF
                files, fetch data by PDB ID or use pre-selected samples.
              </p>
            </div>
            {
              <div>
            ...
            <div className="flex flex-col gap-2 h-[170px] items-center">
              <div>
