        ...
        <div className="flex min-h-screen flex-col items-center pb-16">
            ...
            >
                ...
                <ul className="list-disc list-inside ml-6">
                    ...
                    <li>In multi-model files, the first model is analyzed by default. Users can switch to another model
                        using options in the analysis panel
                    </li>
                ...
                <h3 className="text-xl font-bold mt-5 mb-4">Visualization and analysis</h3>
                <p>
                    Once a task is submitted, users are redirected to the analysis panel, where they can review the RNA
                    structure. Key panel
                    features include:
                </p>
                <ul className="list-disc list-inside ml-6">
                ...
                <h3 className="text-xl font-bold mt-5 mb-4">Configuration options</h3>
                ...
                <ul className="list-disc ml-8">
                    <li><strong>Fornac options:</strong> Customize the RNA secondary structure graph view to fit your
                        preferences.
                    </li>
                    <li><strong>Analyze Structure:</strong>
                        <ul className="list-disc ml-6">
                            <li>Switch between whole-structure analysis and fragment analysis for focused exploration.
                            </li>
                            <li>Use the "Change Model" button to select and apply a different RNA model for analysis.
                            </li>
                            <li>Set key parameters such as "Radius" and "Interval" for advanced analysis tools like the
                                rolling ball method.
                            </li>
                        </ul>
                    </li>
                ...
                {/*<h3 className="text-2xl font-bold mt-6 mb-2">Interactive Graph Features</h2>*/}
                ...
                <h3 className="text-xl font-bold mt-5 mb-4">Graph customization - Fornac options</h3>
                <p>Enhance the visual experience in both Analysis and Result Panel with options like:</p>
                <ul className="list-disc ml-8">
                    <li><strong>Numbering, Label interval:</strong> Adjust node numbering and interval labels for easier
                        navigation.
                    </li>
                    ...
                    <li><strong>Enable Animation:</strong> Adds dynamic behavior to the graph based on molecular forces.
                    </li>
                    <li>Manipulate the graph's position, zoom using the scroll wheel, or reset with the "C" key.</li>
                </ul>

                <h3 className="text-xl font-bold mt-5 mb-4">Get analysis result</h3>
                ...
                <h3 className="text-xl font-bold mt-5 mb-4">Structure coloring</h3>
                ...
                <ul className="list-disc ml-8">
                    ...
                    <li><strong>3D structure:</strong> For the full structure analysis choose <i>Toggle Controls
                        Panel</i> (key icon in Mol* Viewer UI in top-right corner) -&gt; <i>Polymer actions</i> (three dots in bottom-right
                ...
                <h3 className="text-xl font-bold mt-5 mb-4">Export and Save</h3>
                <p>Export your work using buttons:</p>
                <ul className="list-disc ml-8">
                    <li><strong>Copy link to workspace:</strong> Generate a direct link to the analysis view.</li>
                    <li><strong>Download result files:</strong> Save all analysis-related files in a compressed folder.
                    </li>
                </ul>
                <p className="mt-4">
                </p>
